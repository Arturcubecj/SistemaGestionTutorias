...
export default function AdminDashboard() {
  ...
  const menuAdminEstructurado = [
    ...
    },
    {
      categoria: 'AGENTE IA',
      items: [
        { nombre: 'Métricas de uso IA', ruta: '/dashboards/administrador/ia/metricas', icono: 'bi-graph-up' },
        { nombre: 'Preguntas Frecuentes', ruta: '/dashboards/administrador/ia/faq', icono: 'bi-question-circle' },
        { nombre: 'Base de Conocimiento', ruta: '/dashboards/administrador/ia/conocimiento', icono: 'bi-database' },
      ]
    },
  ];
    ...
    <div className="dashboard-layout">
      ...
      <div className="dashboard-viewport">
        ...
        <main className="main-content-body">
          ...
          <p style={{ color: '#64748b', marginTop: '-5px' }}>Panel de control para la administración del sistema de tutorías.</p>

          <div className="dashboard-grid">
            <section className="dashboard-card-panel">
              <h3>Resumen del sistema</h3>
              <div className="empty-state">No hay datos disponibles en este momento.</div>
            </section>

            <aside className="dashboard-card-panel">
              <h3>Acciones rápidas</h3>
              <div className="quick-actions-list">
                <button className="btn-quick-action primary" onClick={() => setModalAbierto('reportes')}>
                  Ver reportes de tutorías
                </button>
                <button className="btn-quick-action" onClick={() => setModalAbierto('usuarios')}>
                  Gestionar usuarios
                </button>
                <button className="btn-quick-action" onClick={() => setModalAbierto('metricas')}>
      ...
      <Modal isOpen={modalAbierto === 'reportes'} onClose={() => setModalAbierto(null)} titulo="Reporte de Tutorías">
        <ReporteTutorias onCancelar={() => setModalAbierto(null)} />
      </Modal>

      <Modal isOpen={modalAbierto === 'usuarios'} onClose={() => setModalAbierto(null)} titulo="Gestión de Usuarios">
        <GestionUsuarios onCancelar={() => setModalAbierto(null)} />
      </Modal>

      <Modal isOpen={modalAbierto === 'metricas'} onClose={() => setModalAbierto(null)} titulo="Métricas del Agente IA">
