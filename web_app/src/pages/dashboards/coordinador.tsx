...
const summaryCards = [
  {
    ...
    colorClass: "summary-icon--purple",
  },
  {
    label: "Docentes activos",
    valor: "8",
    icono: "bi-person-badge",
    colorClass: "summary-icon--green",
  },
  {
    label: "Estudiantes",
    valor: "145",
    icono: "bi-people",
    colorClass: "summary-icon--amber",
  },
  {
    label: "Pendientes",
    valor: "5",
    icono: "bi-hourglass-split",
    colorClass: "summary-icon--red",
  },
];
      ...
      <div className="dashboard-viewport">
        ...
        <main className="main-content-body">
          {vistaActual === "inicio" && (
            <>
              ...
              <p className="coord-subtitle">
                Panel de control para la coordinación académica.
              </p>
              ...
              <div className="dashboard-grid">
                ...
                <section className="dashboard-card-panel">
                  ...
                  <table className="coord-table">
                    <thead>
                      <tr>
                        {["Estudiante", "Docente", "Asignatura", "Estado"].map(
                          (h) => (
                            <th key={h}>{h}</th>
                          ),
                        )}
                    ...
                    <tbody>
                      {tutoriasRecientes.map((t, i) => (
                        <tr key={i}>
                          ...
                          <td>
                            <span
                              className={`badge-estado ${estadoBadgeClass[t.estado]}`}
                            >
                              {t.estado}
                            </span>
                          </td>
                ...
                <aside className="dashboard-card-panel">
                  ...
                  <div className="quick-actions-list">
                    <button
                      ...
                      onClick={() => setVistaActual("supervisar")}
                    >
                      <i className="bi bi-calendar-check"></i>Supervisar
                      tutorías
                    </button>
                    <button
                    ...
                    >
                      <i className="bi bi-file-earmark-bar-graph"></i>Ver
                      reportes
                    </button>
                    <button
                      className="btn-quick-action"
          ...
          {vistaActual === "asignaturas" && (
            <AsignaturasCoordinador onVolver={() => setVistaActual("inicio")} />
          )}
          {vistaActual === "docentes" && (
            <DocentesCoordinador onVolver={() => setVistaActual("inicio")} />
          )}
